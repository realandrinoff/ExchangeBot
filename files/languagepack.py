eng = {
    "start": "Hello! Welcome to my bot! \n\n<b>Who am I?</b> \nI'm a student who designed this project on economics lessons.\n\n<b>How to use this?</b>\nTo start use /exchange, also use /rus, /ukr to change the language. \n\n<b>CONTACTS</b>\n@andrinoff on all social media",
...
rus = {
    ...
    "result.2": ".\n\n\n\nСпасибо за использование! \n Напишите /stop, чтобы продолжить\n\n Создатель: @andrinoff",
    "error": 'Ошибка! \n Вы начнете сначала',
...
kar = {
    ...
    "amounterror": "დაწერეთ მხოლოდ თანხის რაოდენობა",
    "currency1": "ახლა ჩაწერეთ ვალუტა (მაგ. USD, GEL, EUR).",
    "currencyerror1": "არასწორი ვალუტა ",
    "currencyerror2": "არასწორი ვალუტა",
    "currency2.1": "დაწერეთ თქვენთვის სასურველი ვალუტა ",
    "currency2.2": "",
    "result.1": 'თქვენი კურსი',
    "result.2": "\n\n\nმადლობა ჩემი სერვისის გამოყენებისთვის!\n დაბეჭდე /stop გასაგრძელებლად ",
